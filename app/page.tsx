...
export default function Page() {
  ...
  const nominees = [
    ...
    {
      id: "98",
      name: "Victor Adam Ogbleba",
      fullName: "Victor Adam Ogbleba",
      nickname: "",
      dateOfBirth: "4/18",
      department: "Computer science",
      nfcsSociety: "Nil",
      bestLevel: "500l",
      funMoment: "Hanging out with friends/being in church.",
      bio: "Nothing important",
      stressfulLevel: "300l",
      stateOrTribe: "Benue/ idoma",
      hobby: "Prompting ChatGPT/ playing football",
      relationshipStatus: "Single",
      forumPaddy: "Basil",
      forumCrush: "JOVITA",
      bibleVerse: "Mattew 7:7",
      favQuote: "Life is dynamic, live a little but work harder!",
      favSlang: "Guyyy!",
      japaOrStay: "Japa",
      skill: "Survival/ surviving",
      partingWords:
        "Be a part of your forum as soon as you can. Missing out on it isn’t worth it.",
      imageUrl:
        "https://drive.google.com/thumbnail?id=1_z9h7od5yoA3ts9APMz-GS4I2DeVZ39z",
    },
    {
      id: "99",
      name: "Moses Chibunna NWUZOR",
      fullName: "Moses Chibunna NWUZOR",
      nickname: "Onowu of London",
      dateOfBirth: "5/1",
      department: "Building",
      nfcsSociety: "Legion of Mary",
      bestLevel: "500l",
      funMoment: "Opening each pages of Life with Excellence family",
      bio: "In a nutshell, I resonate in Genesis 1^26-27 & Philippines 4^13",
      stressfulLevel: "100l",
      stateOrTribe: "Ebonyi/Igbo",
      hobby:
        "Exploring every trend in the construction industry/built environment, Mentoring, Reading, Research, Football, & Music.",
      relationshipStatus: "Single",
      forumPaddy: "Henry, Mercy, Emmytech, Cecilia, Doris, Israel, David.",
      forumCrush: "Nill",
      bibleVerse: "Ecclesiastes 12^13",
      favQuote:
        "Destiny Demands Diligence, if you can't do great things do small things in a great way (Myles Munroe & Napoleon Hill)",
      favSlang: "",
      japaOrStay: "",
      skill: "BBECC LTD, PVF, and PVA.",
      partingWords:
        "Until you have discovered your unique God given Purpose for life, and that Purpose pursue you more than you pursue it, you are still in probation with your Destiny. (Moses Nwuzor)",
      imageUrl:
        "https://drive.google.com/thumbnail?id=164vmHGq67Eo6g4OG4wEoKRwgqt_gd-pP",
    },
    {
      id: "100",
      name: "Onwuka Lilian Ifenna",
      fullName: "Onwuka Lilian Ifenna",
      nickname: "Lee",
      dateOfBirth: "9/7",
      department: "Food Science and Technology",
      nfcsSociety: "Legion of Mary",
      bestLevel: "500l",
      funMoment: "Hangout with friends, Vacation, etc",
      bio: "A peaceful being",
      stressfulLevel: "300l",
      stateOrTribe: "Cameroon/Anambra/Igbo",
      hobby: "Presenting, listening to music, dancing, Cheffing up",
      relationshipStatus: "In a relationship",
      forumPaddy: "Sem, Mary, Emmanuel, Michael, Eric",
      forumCrush: "Myself",
      bibleVerse: "Psalm 23:1",
      favQuote:
        "In life, there is only 1% inspiration and 99% perspiration perspiration",
      favSlang: "Everybody go dey alright",
      japaOrStay: "Japa",
      skill: "Voice over artistry, Culinary activities, modelling",
      partingWords:
        "Make sure you know what you're doing and do not get carried away.",
      imageUrl:
        "https://drive.google.com/thumbnail?id=1cohExqqx5M2TiIsLKhFLMrhDVvpdJEsS",
    },

    {
      id: "102",
      name: "Gemana Solomon",
      fullName: "Gemana Solomon",
      nickname: "Bigsolo",
      dateOfBirth: "3/22",
      department: "Quantity Surveying",
      nfcsSociety: "Once in Choir",
      bestLevel: "500l",
      funMoment: "Award Night",
      bio: "Not sure",
      stressfulLevel: "200l",
      stateOrTribe: "Benue State/Tiv",
      hobby: "music, gaming, watching movies and online researching",
      relationshipStatus: "In a relationship",
      forumPaddy: "Robert, Alfred and others",
      forumCrush: "Non",
      bibleVerse: "Psalm 23,51,91",
      faVQuote: "You can if you think you can",
      faVSlang: "Omoooo on God",
      japaOrStay: "Stay",
      skill: "Entrepreneur",
      partingWords: "Trust in God,Believe in yourself and always ask questions",
      imageUrl:
        "https://drive.google.com/open?id=1aLgHUbEgkdmbXPZElrPF0V8adPc72w0P",
    },
    {
      id: "103",
      name: "Ruth Ejeh",
      ...
      nfcsSociety: "NFCS",
      bestLevel: "400l",
      funMoment: "When ever am with my sister",
      bio: "Am a bussiness woman",
      stressfulLevel: "200l",
      stateOrTribe: "Kogi state",
      hobby: "Researching ways to improve my business",
      relationshipStatus: "In a relationship",
      forumPaddy: "Vincent",
      forumCrush: "Nill",
      bibleVerse: "Mark 11:24",
      faVQuote: "With God all this are possible",
      faVSlang: "God when",
      japaOrStay: "Stay",
      skill: "Fashion designer, trichologist",
      partingWords: "Do your best and stay focused",
      imageUrl:
        "https://drive.google.com/open?id=1XhmFm9RAHdbl_RWFoAZyo8LVSzmFFpAV",
    },
    {
      id: "104",
      name: "Ugorji lucy chiamaka",
      fullName: "Ugorji lucy chiamaka",
      nickname: "Lucia",
      dateOfBirth: "9/29",
      department: "Science education",
      nfcsSociety: "500l forum",
      bestLevel: "500l",
      funMoment: "Moments with my friends",
      bio: "I’m Lucy by name and I’m an introvert",
      stressfulLevel: "500l",
      stateOrTribe: "Imo state",
      hobby: "Sleeping, eating and minding my business",
      relationshipStatus: "In a relationship",
      forumPaddy: "Everybody",
      forumCrush: "Lol",
      bibleVerse: "Isaiah 46:4",
      faVQuote:
        "IF YOU DON'T BUILD YOUR DREAM, SOMEONE ELSE WILL HIRE YOU TO BUILD THEIRS.",
      faVSlang: "None",
      japaOrStay: "Stay",
      skill: "Pedicurist and nail tech",
      partingWords: "Stay humble and do your best",
      imageUrl:
        "https://drive.google.com/open?id=1XjnWowUVauzWkUrmr_LcjqMVTl-3JIHn",
    },
    {
      id: "105",
      name: "Bube Wubongochuwe Joseph",
      fullName: "Bube Wubongochuwe Joseph",
      nickname: "AlutaJoeboy",
      dateOfBirth: "2/26",
      department: "Biological Sciences",
      nfcsSociety: "Board of Lectors, Church Wardens",
      bestLevel: "400l",
      funMoment: "Time spent with Exquisite comrades",
      bio: "Probably I'm a nice guy. Who knows",
      stressfulLevel: "500l",
      stateOrTribe: "Cross River State/Mbube",
      hobby: "Football, games (efootball), movies",
      relationshipStatus: "Single",
      forumPaddy:
        "Sir Vic (Alphonsus), Kayla, Ufomadu, Licia... Exquisite comrades",
      forumCrush: "All the best!",
      bibleVerse: "John 11:35...say man cry no be crime",
      faVQuote: "Que Sera Sera 🙂",
      faVSlang: "If at all",
      japaOrStay: "Stay",
      skill: "🙂",
      partingWords: "Survival is Winning. God go see us through",
      imageUrl:
        "https://drive.google.com/thumbnail?id=1oGjFN5eoO1KtMd-5J-lz0c9pdNMSAjWz",
    },
    {
      id: "106",
      name: "Alfa Vincent OnucheOjo",
      fullName: "Alfa Vincent OnucheOjo",
      nickname: "Vince",
      dateOfBirth: "9/20",
      department: "SLM",
      nfcsSociety: "Legion of Mary",
      ...
      forumCrush: "Nill",
      bibleVerse: "Psalm 121",
      faVQuote: "Fortune favors the bold",
      faVSlang: "Hmm",
      japaOrStay: "Stay",
      skill: "Trading/freelancing",
      partingWords:
        "You owe your self alot, so make sure you enjoy your exsistance.",
      imageUrl:
    ...
    },
    {
      ...
      relationshipStatus: "Single",
      forumPaddy: "John",
      forumCrush: "Still searching",
      bibleVerse: "Psalm 23",
      faVQuote: "The lord is my shepherd there's nothing I shall want",
      faVSlang: "Dis life no balance",
      japaOrStay: "Japa",
      skill: "Programming",
      partingWords: "Live your life to the fullest",
      imageUrl:
        "https://drive.google.com/thumbnail?id=1jRv5VteMLMSEc3y0hOijw90EPhSdZmZW",
    },
    {
      id: "108",
      name: "Chizzy & Mary",
      imageUrl: "/chizzy-clique-gk.jpg",
    },
  ];
  ...
  const handleAddNomination = () => {
    if (nominee && category && email) {
      ...
      setTimeout(() => {
        ...
        setNominee("");
        setCategory("");
        setAmount(amount + quantity * 100);
        setQuantity(1);
        setIsAdding(false);
      }, 300);
    } else {
      alert(
        "Please fill in all required fields: nominee, category, and email."
      );
    }
  };

  const handleRemoveNomination = (id: number, nomQuantity: number) => {
    setNominations(nominations.filter((nomination) => nomination.id !== id));
    setAmount(amount - nomQuantity * 100);
  };
  ...
  const canMakePayment = nominations.length > 0 && email && !isSubmitting;
      ...
      fetch("/api/paystack-webhook", {
        ...
        .then((result) => {
          if (result.status === "success") {
            ...
            alert("Payment verified, but failed to submit nominations.");
          }
        });
      setNominations([]);
      setAmount(0);
  ...
  return (
    <div className="min-h-screen w-screen p-4 flex flex-col justify-center items-center text-slate-400 bg-gradient-to-br from-slate-50 to-blue-50 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                {nominee && (
                  <button
                    onClick={() => handleViewProfile(nominee)}
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">
                Nomination Amount (₦100 per vote) *
              </label>
              <input
                type="number"
                min="1"
            ...
            <button
              ...
              disabled={!nominee || !category || !email || isAdding}
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          {nominations.length === 0 ? (
            <div className="text-center py-8 text-slate-500">
              <p>You have not nominated anyone yet</p>
            </div>
          ) : (
            <div className="space-y-4">
              {nominations.map((nom) => (
                ...
                >
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-blue-600">
                      {nom.quantity} vote(s) - ₦{nom.quantity * 100}
                    </p>
                  </div>
                  <div className="flex gap-2">
                    <button
              ...
              <div className="border-t pt-4 mt-4">
                ...
                <p className="text-sm text-slate-500 mt-1">
                  {nominations.length} nomination(s) total
                </p>
              </div>
              {/* Payment Button */}
              <div className="mt-6">
                ...
                {isSubmitting && (
                  <div className="text-center text-blue-600 mt-2">
                    Processing payment and submissions...
                  </div>
                )}
                {!email && nominations.length > 0 && (
        ...
        >
          ...
          >
            <div className="relative">
              ...
              {/* Profile Image */}
              <div className="h-64 bg-gradient-to-br from-blue-100 to-purple-100 rounded-t-xl overflow-hidden flex justify-center items-center">
                {viewingProfile.imageUrl ? (
                  ...
                  <div className="w-48 h-48 rounded-full bg-gray-200 flex items-center justify-center border-4 border-white">
                    <svg
      ...
      <div className="mt-8 text-center text-sm text-slate-500">
        <p>Need help? Contact: 08121315694</p>
        <p className="mt-1">
          © {new Date().getFullYear()} NFCS Nox Amoris Awards
        </p>
      </div>
    </div>
  );
