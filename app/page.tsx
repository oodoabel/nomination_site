...
export default function page() {
  ...
  const nominees = [
    ...
    },
    {
      ...
      imageUrl:
        "https://drive.google.com/thumbnail?id=1ovBgrMi22Qo2DzZdPTvGF_GiGOT1ZOLC",
    },
    {
      id: "76",
      ...
      relationshipStatus: "Single",
      forumPaddy:
        "Chizoba, Emmanuel, Chisom,Vincent, EstherFrancis, Onume, Joyce ,the list continues",
      forumCrush: "Chizoba",
      bibleVerse: "Romans 8:18",
      favQuote: "Just do it. (It's not over till it's over)",
      favSlang: "On God",
      japaOrStay: "Japa",
      skill: "Photography(Creative director), Web3 enthusiast",
      partingWords:
        "Don't dwell on sad times, Try to always be positive and happy with every situation you find yourself.",
      imageUrl:
        "https://drive.google.com/thumbnail?id=1Y2HettRzwwNs5GxM54di4tie7_vt8dnX",
    },
    {
      id: "77",
      ...
      stressfulLevel: "300l",
      stateOrTribe: "BENUE/IDOMA",
      hobby: "FIXING GADGETS, CRITICAL THINKING, WATCHING FOOTBALL AND COOKING",
      relationshipStatus: "In a relationship",
