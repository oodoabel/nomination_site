...
export default function page() {
  ...
  const componentProps = {
    ...
    text: "Make Payment",
    onSuccess: () => {
      console.log("Payment successful, submitting nominations...");
      ...
      nominationsCopy.forEach((nom) => {
        submitNomination(nom.nominee, nom.category, nom.quantity)
          .then((result) => {
            console.log(`Nomination for ${nom.nominee} result:`, result);
          })
          .catch((error) => {
            console.error(
              `Failed to submit nomination for ${nom.nominee}:`,
              error
            );
          });
      });
